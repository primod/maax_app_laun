...
public class PluginManager
{
  ...
  public boolean exec(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      PluginResult localPluginResult1 = new PluginResult(PluginResult.Status.CLASS_NOT_FOUND_EXCEPTION);
    ...
    try
    {
      ...
      {
        PluginResult localPluginResult3 = new PluginResult(PluginResult.Status.INVALID_ACTION);
    ...
    {
      PluginResult localPluginResult2 = new PluginResult(PluginResult.Status.JSON_EXCEPTION);
