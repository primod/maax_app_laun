  ...
  extends WebView
{
  ...
  public void loadUrlIntoView(final String paramString)
  {
    ...
    label155:
    for (this.baseUrl = paramString.substring(0, j + 1);; this.baseUrl = (this.url + "/"))
    {
      this.pluginManager.init();
      if (!this.useBrowserHistory) {
        this.urls.push(paramString);
      }
  ...
  {
    if ((paramString.startsWith("javascript:")) || (this.urls.size() > 0) || (canGoBack())) {}
    for (;;)
    {
      loadUrlIntoView(paramString);
      return;
  ...
  void loadUrlNow(String paramString)
  {
    ...
    if ((paramString.startsWith("file://")) || (paramString.indexOf(this.baseUrl) == 0) || (paramString.startsWith("javascript:")) || (Config.isUrlWhiteListed(paramString))) {
  ...
  public void pushUrl(String paramString)
  {
    this.urls.push(paramString);
  }
  ...
  public void showWebPage(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, Object> paramHashMap)
  {
    ...
    if (!paramBoolean1)
    {
      if ((paramString.startsWith("file://")) || (paramString.indexOf(this.baseUrl) == 0) || (Config.isUrlWhiteListed(paramString)))
      {
        if (paramBoolean2) {
          this.urls.clear();
        }
