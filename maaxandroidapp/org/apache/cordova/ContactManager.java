  ...
  extends CordovaPlugin
{
    ...
    throws JSONException
  {
    ...
    {
      final JSONArray localJSONArray = paramJSONArray.getJSONArray(0);
      final JSONObject localJSONObject2 = paramJSONArray.getJSONObject(1);
      this.cordova.getThreadPool().execute(new Runnable()
      {
        public void run()
        {
          JSONArray localJSONArray = ContactManager.this.contactAccessor.search(localJSONArray, localJSONObject2);
    ...
    {
      final JSONObject localJSONObject1 = paramJSONArray.getJSONObject(0);
      this.cordova.getThreadPool().execute(new Runnable()
      {
        public void run()
        {
          String str = ContactManager.this.contactAccessor.save(localJSONObject1);
          ...
          if (localObject != null)
          {
            paramCallbackContext.success(localObject);
            return;
          }
        }
      });
    ...
    {
      final String str = paramJSONArray.getString(0);
      this.cordova.getThreadPool().execute(new Runnable()
      {
        public void run()
        {
          if (ContactManager.this.contactAccessor.remove(str))
          {
