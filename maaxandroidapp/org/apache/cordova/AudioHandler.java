  ...
  extends CordovaPlugin
{
    ...
    throws JSONException
  {
    ...
    if (paramString.equals("startRecordingAudio")) {
      startRecordingAudio(paramJSONArray.getString(0), FileUtils.stripFileProtocol(paramJSONArray.getString(1)));
    }
    for (;;)
    {
      ...
      {
        startPlayingAudio(paramJSONArray.getString(0), FileUtils.stripFileProtocol(paramJSONArray.getString(1)));
      }
      ...
      else
      {
        ...
        AudioPlayer localAudioPlayer = new AudioPlayer(this, str, FileUtils.stripFileProtocol(paramJSONArray.getString(1)));
