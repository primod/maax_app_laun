  ...
  extends WebViewClient
{
  ...
  {
    if (!this.appView.peekAtUrlStack().equals(paramString)) {
      this.appView.pushUrl(paramString);
    }
  }
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramString.startsWith("file://")) || (paramString.startsWith("data:")) || (paramString.indexOf(this.appView.baseUrl) == 0) || (Config.isUrlWhiteListed(paramString)))
        {
          if ((this.appView.useBrowserHistory) || (paramString.startsWith("data:"))) {
            return false;
          }
